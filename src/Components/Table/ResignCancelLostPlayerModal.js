...
const UnconnectedResignCancelLostPlayerModal = (props) => {
    ...
    const force_resign = () => {
        props.send_message({dsgForceCancelResignTableEvent: {action: 2, player: props.table.me, table: props.table.table, time: 0}});
    };
    const cancel = () => {
        props.send_message({dsgForceCancelResignTableEvent: {action: 1, player: props.table.me, table: props.table.table, time: 0}});
    };
