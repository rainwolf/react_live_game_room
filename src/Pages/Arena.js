...
class UnconnectedArena extends Component {
   componentDidUpdate() {
   ...
   toggleCreateArenaModal = () => {
      this.props.toggle_create_arena_modal();
   }
...
const Arena = connect(mapStateToProps, mapDispatchToProps)(UnconnectedArena);

UnconnectedArena.propTypes = {
